...
export default function AdminLogin() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault()
    // Mock login logic - in real app use Supabase Auth
  ...
  return (
    <div className="min-h-screen bg-secondary flex items-center justify-center p-16">
      <Card className="w-full max-w-md border-none shadow-subtle rounded-xl overflow-hidden">
        <CardHeader className="bg-white border-b border-border py-32 text-center">
        ...
        <CardContent className="bg-white py-32 space-y-24">
